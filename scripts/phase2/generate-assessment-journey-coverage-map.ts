...
const rows: Row[] = [
  ...
  ["Stale-answer deletion after branch removal", "X-JRN-03", "assessmentJourney.test.ts", "X-JRN-03", "engine.answers.has(GF-F1) false after onScreeningChanged", "unit"],
  ...
  ["PDF access without SMS consent", "X-JRN-PIPE-03", "assessmentJourneyPipeline.test.ts", "X-JRN-PIPE-03", "reportToken truthy without SMS consent", "server"],
  ...
  ["Equal-priority/tie presentation", "X-JRN-10", "assessmentJourney.test.ts", "X-JRN-10", "tiedGroup length > 1", "unit"],
  ["Successful report access", "X-JRN-PIPE-05", "assessmentJourneyPipeline.test.ts", "X-JRN-PIPE-05", "serveAssessmentTokenPdf status 200 application/pdf", "server"],
  ["Repeat report access", "X-JRN-PIPE-05", "assessmentJourneyPipeline.test.ts", "X-JRN-PIPE-05", "second serveAssessmentTokenPdf status 200", "server"],
  ["Invalid token behavior", "X-JRN-PIPE-06, X-JRN-DOM-12", "assessmentJourneyPipeline.test.ts / assessment.browserJourney.test.ts", "X-JRN-PIPE-06 / X-JRN-DOM-12", "404 plain text expired or invalid", "server+browser/DOM"],
  ["Expired token behavior", "X-JRN-PIPE-06, X-JRN-DOM-12", "assessmentJourneyPipeline.test.ts / assessment.browserJourney.test.ts", "X-JRN-PIPE-06 / X-JRN-DOM-12", "getAssessmentReportTokenData null → 404", "server+browser/DOM"],
  ["Retryable report failure with recovery action", "X-JRN-PIPE-07, X-JRN-DOM-13", "assessmentJourneyPipeline.test.ts / assessment.browserJourney.test.ts", "X-JRN-PIPE-07 / X-JRN-DOM-13", "recovery message string; validation recovery to results", "server+browser/DOM"],
