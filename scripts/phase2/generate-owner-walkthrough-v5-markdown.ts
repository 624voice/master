...
add({
  ...
  steps: [
    ...
    "Verify focused element immediately after BP1 render: Document body (no control focused). Verified by X-SAFE-PREVIEW-FOCUS-04 browser capture.",
    "Press Tab. Verify focused element: Continue button.",
    "Press Enter.",
    ...
    "Press Tab. Verify focused element: Continue button.",
    "Press Enter.",
    "Verify rendered screen: Respond review screen with Monthly inbound calls field visible.",
    "Verify focused element immediately after respond review render: Continue button. Verified by X-SAFE-PREVIEW-FOCUS-04 browser capture.",
  ],
...
const md = [
  ...
  "",
  `**Final executable preview checkout SHA:** \`${EXECUTABLE_SHA}\``,
  "",
  "## CHECKOUT",
  "",
  "```bash",
