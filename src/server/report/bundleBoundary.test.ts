...
describe("assessment PDF bundle boundary", () => {
  ...
  test("X-BND-13: assessment token route dynamically imports isolated server handler", async () => {
  ...
  test("X-BND-14: assessment PDF bytes use isolated renderAssessmentPdf pipeline", async () => {
