...
import {
  ...
  rankSlotsForOffer,
  slotStartMinutes,
} from "~/server/speed2Lead/agent/scheduling/slotRanking";
import {
...
import { fromCanonicalSchedulingState, toCanonicalSchedulingState } from "~/server/speed2Lead/agent/scheduling/state";
